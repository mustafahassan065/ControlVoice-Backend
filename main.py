...
import models
from routes import auth_routes, audio_routes, exercise_routes, program_routes, email_routes,progress_routes,stripe_routes,report_routes,challenge_routes,coach_routes, email_preference_routes,onboarding_routes,training_routes,live_coach_routes
...
app.include_router(live_coach_routes.router)
